...
function InputBoxDate(const ACaption, APrompt: string; var ADate: Variant): boolean;
...
begin
  ...
  begin
    ...
    Application.MessageBox('Не введена дата', 'Не введены данные', MB_ICONERROR + MB_YESNOCANCEL);
  end;
end;
