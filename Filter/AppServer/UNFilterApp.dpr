...
uses
  ...
  UNFilterApp_TLB in 'UNFilterApp_TLB.pas',
  uRDM in 'uRDM.pas' {Dic: TRemoteDataModule},
...
begin
  ...
  begin
    ...
    ural_FLT := Tural_FLT.CreateNew(SvcMgr.Application, 0);
...
// Добавлено ручками
      ...
      RegisterCOMService(CLASS_UnFilter, ural_FLT.Name);
    end;
