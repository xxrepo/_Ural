...
type
  ...
  TSnez = class(TRemoteDataModule, ISnez)
    ...
    qBsn: TADOQuery;
    qBsnid_Main: TIntegerField;
    qOp: TADOQuery;
    IntegerField37: TIntegerField;
    spRPT_NewRepTree: TADOStoredProc;
    dsRPT_NewRepTree: TDataSetProvider;
    spRepSvod: TADOStoredProc;
    dsRepSvod: TDataSetProvider;
    dsRPT_OLD_CA: TDataSetProvider;
    spRPT_OLD_CA: TADOStoredProc;
    dsRPT_OLD_WARE: TDataSetProvider;
    spRPT_OLD_WARE: TADOStoredProc;
    spBJList2: TADOStoredProc;
    dsBJList2: TDataSetProvider;
    spBJTree2: TADOStoredProc;
    dsBJTree2: TDataSetProvider;
    spBIP2: TADOStoredProc;
    dsBIP2: TDataSetProvider;
    spBIP2isDeb: TBooleanField;
    spBIP2P_Name: TStringField;
    spBIP2id_BJ_Obj: TIntegerField;
    spBIP2id_business: TIntegerField;
    spBIP2ExtID: TIntegerField;
    spBIP2RealName: TStringField;
    spBIP2id_BJ_Item: TAutoIncField;
    spBIP2id_BJ_Tree: TIntegerField;
    spBIP2Name: TStringField;
    spBIP2Disabled: TBooleanField;
    spBIP2PlanIn: TBCDField;
    spBIP2PlanDelta: TBCDField;
    spBIP2id_Acc: TIntegerField;
    spBIP2id_ContrAgent: TIntegerField;
    spBIP2OrdNum_I: TIntegerField;
    spBIP2old_I: TIntegerField;
    spBIP2PlanCorrect: TBCDField;
    spBIP2isDirect: TBooleanField;
    spBIP2isInState: TBooleanField;
    spBIP2PlanDelta1: TFloatField;
    spBIP2PlanCorrect1: TFloatField;
    spBIP2PlanDelta2: TFloatField;
    spBIP2PlanCorrect2: TFloatField;
    spBIP2PlanDelta3: TFloatField;
    spBIP2PlanCorrect3: TFloatField;
    spBIP2PlanDelta4: TFloatField;
    spBIP2PlanCorrect4: TFloatField;
    spBIP2PlanDelta5: TFloatField;
    spBIP2PlanCorrect5: TFloatField;
    spBIP2PlanDelta6: TFloatField;
    spBIP2PlanCorrect6: TFloatField;
    spBIP2PlanDelta7: TFloatField;
    spBIP2PlanCorrect7: TFloatField;
    spBIP2PlanDelta8: TFloatField;
    spBIP2PlanCorrect8: TFloatField;
    spBIP2PlanDelta9: TFloatField;
    spBIP2PlanCorrect9: TFloatField;
    spBIP2PlanDelta10: TFloatField;
    spBIP2PlanCorrect10: TFloatField;
    spBIP2PlanDelta11: TFloatField;
    spBIP2PlanCorrect11: TFloatField;
    spBIP2PlanDelta12: TFloatField;
    spBIP2PlanCorrect12: TFloatField;
    spBJDet2: TADOStoredProc;
    dsBJDet2: TDataSetProvider;
    spPPid_BSN: TIntegerField;
    spPPOLD_PPP: TIntegerField;
    spOperBJ: TADOStoredProc;
    ...
    spObr: TADOStoredProc;
    dsOrb: TDataSetProvider;
    spInvDict: TADOStoredProc;
    dsInvDict: TDataSetProvider;
    dsInvC: TDataSetProvider;
    spInvC: TADOStoredProc;
    spPrevFact: TADOStoredProc;
    dsPrevFact: TDataSetProvider;
    spPPLineNum: TIntegerField;
    spPrjListid_BSN: TIntegerField;
    spPrjListOLD_PPP: TIntegerField;
    spPrjListLineNum: TIntegerField;
  ...
  private
    ...
    function SetProcedureName(AProcedureName: String): Integer;
  ...
  protected
    ...
    procedure INV_LinesPrice(OrdNum, id_business: Integer; var id_Lines,
    ...
    function DCh_WareGoodsAdd(id_business: Integer; CtgName, AName: OleVariant;
      id_Measure: Integer): Integer; safecall;
    function DCh_WareHouseAdd(id_business: Integer;
      AName: OleVariant): Integer; safecall;
    function DCh_WareAmountAdd(id_business, id_Goods, id_Warehouse,
      id_Measure: Integer; Amount, Price: OleVariant): Integer; safecall;
    function DCh_ReprAdd(id_business: Integer; AName,
      CAName: OleVariant): Integer; safecall;
    function DCh_CA_DeptAdd(id_business, id_Repr: Integer; S_RUB, S_USD,
      S_EUR: OleVariant): Integer; safecall;
    function DCh_WareAmount_IMP(id_Goods_OLD, id_Goods_NEW: Integer): Integer;
      safecall;
    function PL_Ctg_Goods_COPY(id_business_OLD, id_business_new: Integer;
      NeedAmount: WordBool): Integer; safecall;
    function Bsn_BlockBusiness(id_business: Integer; Block: WordBool): Integer;
      safecall;
    function BJ_ObjEdit_v2(id_BJ_Obj, id_business: Integer; AName, StartDate,
      StopDate: OleVariant): Integer; safecall;
    function BJ_ItemEdit_v2(id_BJ_Item, id_BJ_Tree, AName, PlanIn,
      ...
      PlanCorrect11, PlanDelta12, PlanCorrect12: OleVariant): Integer;
      safecall;
    procedure BJ_Copy2(OLD_ID, NEW_ID: Integer); safecall;
    function AddGoods(Atype, GoodsCatName, GoodsName, Price, Ball,
      Descr: OleVariant): Integer; safecall;
    function BJ_SetInitial(id_BJ_Obj, Month, SetNull: OleVariant): Integer;
      safecall;
    procedure BJ_OperRelEDIT(id_BJ_Obj, id_BJ_Item, id_Oper: Integer);
      safecall;
    function WareUnEdit(id_Goods: Integer; id_Ctg_Goods, AName, ShortName,
      BarCode: OleVariant; Disabled: WordBool; id_Measure, GTD, Country,
      DocNomCode, DocPriceCode, DocArt, DocNumber,
      Price: OleVariant): Integer; safecall;
    function Imp_Oper_UnEdit(id_Bsn, OperDate, Summ, Narr, ReprName, OperType,
      OperNum, OperNum2, Acc: OleVariant): Integer; safecall;
    function Inv_DictAdd(xType: Integer; Val: OleVariant): Integer; safecall;
    function OP_BlockIt(id_business: Integer; VirtDate: OleVariant): Integer;
      safecall;
  public
    ...
    function IsBsnAv(id_business, id_Oper : integer) : boolean;
  end;

implementation

uses uMeCrpt, uEventLogger, tstSvcForm, uDM_2;
...
class procedure TSnez.UpdateRegistry(Register: Boolean; const ClassID, ProgID: string);
begin
  if Register then
  begin
...
procedure TSnez.RemoteDataModuleCreate(Sender: TObject);
var Buffer : PChar;
    Len : DWORD;
    CmpName : String;
    i : integer;
...
//  THackAdoDataSet(DM.spArc2).CommandTimeout := 60*3;
  ...
  THackAdoDataSet(spRepSvod).CommandTimeout := 60*2;
  THackAdoDataSet(spRPT_OLD_CA).CommandTimeout := 60*2;
  THackAdoDataSet(spRPT_OLD_WARE).CommandTimeout := 60*2;
...
// ****************************************************************************
  ...
  begin
    ...
    begin
     ...
     //     FDataBaseName := Values['DataBaseName'];
        end;
      finally
        IniFile.Free;
      end;
...
procedure TSnez.SQLUpdateDSUpdateError(Sender: TObject;
  DataSet: TClientDataSet; E: EUpdateError; UpdateKind: TUpdateKind;
  var Response: TResolverResponse);
begin
...
function TSnez.DoLogin(UserName, Password: OleVariant): Integer;
begin
//  LogMessage('DoLogin');
 ...
 //      raise Exception.Create('Ошибка при подключени к базе FUserName=' + FUserName+ ' FPassword='  + FPassword + ' FDataBaseName=' + FDataBaseName);
   Connected := false;
...
// exit;
  //   LogMessage('DoLogin 2');
     ...
     begin
       Result := 26;
       LogMessage('Ошибка при подключени к базе ' + FUserName+ ' '  + FPassword + ' ' + FDataBaseName + ' ' + E.Message, EVENTLOG_ERROR_TYPE, 1, 1);
     //  raise Exception.Create('Ошибка при подключени к базе ' + FUserName+ ' '  + FPassword + ' ' + FDataBaseName + ' ' + E.Message);
       raise Exception.Create('Ошибка при подключени к базе ' + FDataBaseName + ' ' + E.Message);
     end;
   end;
 end;
...
procedure TSnez.LogMessage(Message: String; EventType: DWord;
  Category: Word; ID: DWord);
begin
  FEventLogger.LogMessage(Message, EventType, Category, ID);
end;

function TSnez.CAGroup_Add(id_Bsn: Integer; AName: OleVariant;
...
function TSnez.CAGroup_Edit(ID: Integer; AName: OleVariant;
  ShowInRoot: WordBool): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
...
function TSnez.CAGroup_Del(ID: Integer): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.Get_id_User: OleVariant;
begin
  Result := Fid_User;
end;

function TSnez.Get_FIO: OleVariant;
begin
  Result := FFullFio;
end;

function TSnez.CurByID(ID: OleVariant; out AName, AShortName: OleVariant;
...
function TSnez.ContrAgentAdd(AName, id_business, id_CAGroup: OleVariant;
  isOwn: WordBool; Id_Currency, Addr, Descr: OleVariant;
  ShowInRoot: WordBool): Integer;
begin
  Result := -1;
...
function TSnez.ContrAgentEdit(id_ContrAgent: Integer; AName, id_business,
  id_CAGroup: OleVariant; isOwn, Disabled: WordBool; Id_Currency, Addr,
...
procedure TSnez.BeginTruns;
begin
  ADOConnection1.BeginTrans;
end;

procedure TSnez.CommitTrans;
begin
  ADOConnection1.CommitTrans;
end;

procedure TSnez.RollbackTrans;
begin
  ADOConnection1.RollbackTrans;
end;

function TSnez.ReprAdd(id_ContrAgent: OleVariant; isJur: WordBool; AName,
  FirstName, MiddleName, LastName, Id_Currency: OleVariant;
  Disabled: WordBool; Addr, Descr, id_Bsn_ex: OleVariant;
  NeedSend: Integer; BIK, Bank, AccName, CorAccNAme, OKPO, INN,
...
function TSnez.ReprEdit(id_Repr: Integer; id_ContrAgent: OleVariant;
  isJur: WordBool; AName, FirstName, MiddleName, LastName,
  Id_Currency: OleVariant; Disabled: WordBool; Addr, Descr: OleVariant;
  NeedSend: Integer; BIK, Bank, AccName, CorAccNAme, OKPO, INN,
  KPP: OleVariant): Integer;
...
function TSnez.ContrAgentSetGrp(id_ContrAgent: Integer;
  ...
  begin
    try
      ...
      begin
        ...
        Close;
        LogMessage(ProcedureName + ' ' + E.Message);
        raise Exception.Create('Ошибка при перенесении контрагента в другую группу. ' + E.Message);
      end;
    end;
  end;
end;

function TSnez.Ctg_GoodsAdd(id_business: Integer; id_BaseCtg, AName,
...
function TSnez.Ctg_GoodsEdit(id_Ctg, id_business: Integer; id_BaseCtg,
...
function TSnez.CtgByID(AType: Integer; ID: OleVariant;
  ...
  begin
    try
      ...
      case AType of
        ...
        raise Exception.Create('Неверный параметр функции.');
      end;
      Parameters.Refresh;
...
function TSnez.WareAdd(AType: Integer; id_Ctg, AName, ShortName,
  BarCode: OleVariant; Disabled: WordBool; id_Measure, GTD, Country,
  DocNomCode, DocPriceCode, DocArt, DocNumber: OleVariant): Integer;
var S_IDCat : String;
begin
...
function TSnez.WareEdit(AType, AID: Integer; id_Ctg, AName, ShortName,
  BarCode: OleVariant; Disabled: WordBool; id_Measure, GTD, Country,
  DocNomCode, DocPriceCode, DocArt, DocNumber: OleVariant): Integer;
...
function TSnez.BsnByID(ID: OleVariant; out AName: OleVariant): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.LC_OP_EmptyAdd(id_UserCreator: Integer; OperTypeIn: WordBool;
  id_DocType, Contract, OpComment: OleVariant; id_business: Integer;
...
function TSnez.LC_OP_EmptyEdit(id_LC_Oper, id_UserCreator: Integer;
  id_DocType, Contract, OpComment: OleVariant; id_business: Integer;
  Imp_PayBasic, AccInv_PayAssignment: OleVariant): Integer;
begin
  Result := -1;
...
function TSnez.LC_OP_DEL(id_LC_Oper: Integer): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.SetUserForOper_Int(id_user: Variant; id_oper: Integer): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.SetUserForOper(id_user: OleVariant;
  id_oper: Integer): Integer;
begin
  Result := SetUserForOper_Int(id_user, id_oper);
end;

function TSnez.OP_OperDel(id_Oper: Integer): Integer;
begin
  if not IsBsnAv(-1, id_Oper) then
    raise Exception.Create('ЭТОТ БИЗНЕС ЗАКРЫТ!!!');
  Result := -1;
  with ADOStoredProc1 do
  begin
    try
...
function TSnez.OP_OperSetCheckDate(id_Oper: Integer;
...
function TSnez.LC_Acc_Add(AName, id_Bsn, id_Group: OleVariant): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.LC_Acc_Edit(AID: Integer; AName,
...
function TSnez.LC_WH_Add(AName, id_Bsn, id_Group: OleVariant): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.LC_WH_Edit(AID: Integer; AName,
  id_Group: OleVariant): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
...
function TSnez.LC_MN_Add(AName, id_Bsn, id_Group: OleVariant): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.LC_MN_Edit(AID: Integer; AName,
  id_Group: OleVariant): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
...
function TSnez.CH_Checked(AID, ObjID: Integer): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
    try
      ...
      begin
        ...
        Close;
        LogMessage(ProcedureName + ' ' + E.Message);
        raise Exception.Create('Ошибка при визировании объекта. ' + E.Message);
      end;
    end;
  end;
end;

function TSnez.OP_OperDelCheckDate(id_Oper: Integer): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.UNSel_AccBsn(Param1: OleVariant; var id_Bsn,
  id_Group: OleVariant): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
...
function TSnez.UNSel_WHBsn(Param1: OleVariant; var id_Bsn,
  id_Group: OleVariant): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
...
function TSnez.UNSel_ManufBsn(Param1: OleVariant; var id_Bsn,
  id_Group: OleVariant): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
...
function TSnez.UNSel_CABsn(Param1: Integer; out isOwn: WordBool;
...
function TSnez.UNSel_ReprBsn_v2(Param1: Integer; var isOwn: WordBool;
  var id_CAGroup, id_Ca, id_Repr_Group, id_Bsn: OleVariant): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
...
function TSnez.UNSel_EQBsn(Param1: Integer): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.UN_Del(AID: Integer; AProcedureName : String): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
    ...
    try
      ...
      begin
        ...
        Close;
        LogMessage(ProcedureName + ' ' + E.Message);
        raise Exception.Create('Ошибка при удалении - ' + E.Message);
      end;
    end;
  end;
end;

function TSnez.PL_Ctg_GoodsDel(Param1: Integer): Integer;
begin
  Result := UN_Del(Param1, 'PL_Ctg_GoodsDel');
end;

function TSnez.PL_GoodsDel(Param1: Integer): Integer;
begin
  Result := UN_Del(Param1, 'PL_GoodsDel');
end;

function TSnez.CA_ContrAgentDel(Param1: Integer): Integer;
begin
  Result := UN_Del(Param1, 'CA_ContrAgentDel');
end;

function TSnez.CA_ReprDel(Param1: Integer): Integer;
begin
  Result := UN_Del(Param1, 'CA_ReprDel');
end;

function TSnez.UNSel_PL_GoodsInf(Param1: Integer): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.OP_OperSetOperState(id_Oper, OperState: Integer): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.BsnNumByID(AID: Integer; var Param2: OleVariant): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.CheckGoods(Param1: OleVariant): Integer;
begin
  Result := CheckWare('UNSel_PL_GoodsExists', Param1);
end;

function TSnez.CheckWare(AProcName : String; AID: OleVariant): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.PL_GetDefsWare(AProcName : String; AID_Ctg: Integer; out Price, ID_Cur: OleVariant): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.PL_GetDefPriceWare(AProcName : String; AID: Integer; ID_Warehouse: OleVariant; out Price, ID_Cur: OleVariant; out TotalAmount: Double): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.PL_GetDefsGoods(AID_Ctg: Integer; out Price,
  ID_Cur: OleVariant): Integer;
begin
  Result := PL_GetDefsWare('PL_GetDefsGoods', AID_Ctg, Price, ID_Cur);
end;

function TSnez.PL_GetDefPriceGoods(AID_Ctg: Integer;
...
begin
  ...
  begin
    Close;
    ProcedureName := 'PL_GetDefPriceGoods';
    try
      Close;
      Parameters.Refresh;
      Parameters.ParamByName('@ID').Value := AID_Ctg;
      if Parameters.FindParam('@ID_Warehouse') <> nil then
        Parameters.ParamByName('@ID_Warehouse').Value := ID_Warehouse;
...
function TSnez.OP_OperGetEditID(id_OperParent: Integer): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.OP_DoOk(id_Oper: Integer): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.OP_DoCancel(id_Oper: Integer): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.LNK_ReLink(AProcedureName : String; id_Old, id_New: Integer): WordBool;
begin
  Result := false;
  with ADOStoredProc1 do
  begin
...
function TSnez.LNK_Acc(id_Old, id_New: Integer): WordBool;
begin
  Result := LNK_ReLink('LNK_Acc', id_Old, id_New);
end;

function TSnez.LNK_Warehouse(id_Old, id_New: Integer): WordBool;
begin
  Result := LNK_ReLink('LNK_Warehouse', id_Old, id_New);
end;

function TSnez.LNK_Repr(id_Old, id_New: Integer): WordBool;
begin
  Result := LNK_ReLink('LNK_Repr', id_Old, id_New);
end;

function TSnez.LNK_Manufact(id_Old, id_New: Integer): WordBool;
begin
  Result := LNK_ReLink('LNK_Manufact', id_Old, id_New);
end;

function TSnez.LNK_Goods(id_Old, id_New: Integer): WordBool;
begin
  Result := LNK_ReLink('LNK_Goods', id_Old, id_New);
end;

function TSnez.OP_BuffAdd(AName: OleVariant): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.OP_BuffDel(id_Buff: Integer): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.OP_BuffEdit(id_Buff: Integer; AName: OleVariant): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.PL_UN_WareCtgGetProp(id_Ctg, ID_TYPE: Integer): OleVariant;
begin
  Result := '';
  with ADOStoredProc1 do
  begin
...
function TSnez.CA_CAGroupGetProp(id_CAGroup: OleVariant): OleVariant;
begin
  Result := '';
  with ADOStoredProc1 do
  begin
...
procedure TSnez.CA_CAGetProp(id_ContrAgent: OleVariant; out AName,
  id_Bsn: OleVariant);
begin
//  Result := '';
  with ADOStoredProc1 do
...
function TSnez.PL_GetAccSum(id_Acc: Integer; out TotalSum: Double): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.DD_DayOpen(id_business: Integer;
...
function TSnez.DD_DayClose(id_business: Integer): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.DD_DayGetProp(id_business: Integer): OleVariant;
begin
  Result := Null;
  with ADOStoredProc1 do
  begin
...
function TSnez.OP_FuncDistribAdd(AName: OleVariant;
...
function TSnez.OP_FuncDistribDel(id_FuncDistrib: Integer): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.OP_FuncDistribEdit(id_FuncDistrib: Integer;
...
function TSnez.OP_FormalDistribAdd(AName: OleVariant;
  id_Bsn: Integer): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
...
function TSnez.OP_FormalDistribDel(id_FormalDistrib: Integer): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.OP_FormalDistribEdit(id_FormalDistrib: Integer;
  AName: OleVariant): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
...
function TSnez.GetWH(ID: Integer; var ANAme, ABsnName, id_Business: OleVariant): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.GetOperNum(id_oper: Integer): OleVariant;
begin
  Result := '';
  with ADOStoredProc1 do
  begin
...
function TSnez.Rights_GetUserRights(id_Func: Integer;
...
function TSnez.Rights_GetFuncName(id_Func: Integer): OleVariant;
begin
  Result := '';
  with ADOStoredProc1 do
  begin
...
function TSnez.OP_Oper_ExtDataNamesEdit(id_Oper_ExtDataNames, id_business,
...
function TSnez.UN_Check_Ctg_Ware(WareType, id_business: Integer; id_Ctg,
...
function TSnez.UN_Check_Ware(WareType: Integer; id_Ctg, AName,
...
function TSnez.UN_Check_CAGroup(id_business: Integer; AName,
  id_Real: OleVariant): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
...
function TSnez.UN_Check_CA_ContrAgent(id_business: Integer; AName,
  id_Real: OleVariant): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
...
function TSnez.UN_Check_CA_Repr(id_ContrAgent: Integer; AName,
  id_Real: OleVariant): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
...
function TSnez.UN_Sel_PL_GoodsCtg(AID: Integer): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.LC_OP_OperSetCheckDate(id_LC_Oper: Integer): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.LC_OP_OperDelCheckDate(id_LC_Oper: Integer): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
procedure TSnez.LC_SetBaseName(AName: OleVariant);
begin
  FDataBaseName := AName;
end;

function TSnez.CH_Deleted(AID, AObjID: Integer): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.RP_WHStateDates_Get: OleVariant;
begin
  Result := Null;
  with ADOStoredProc1 do
  begin
...
function TSnez.xxx_Group_Check_v2(ObjID, id_business: Integer; AName,
...
function TSnez.xxx_Group_Add_v2(ObjID, id_business: Integer;
...
function TSnez.xxx_Group_Edit_v2(ObjID, id_Group: Integer;
  AName: OleVariant; ShowInRoot: WordBool; PID: Integer): Integer;
var PPP : TParameter;
begin
  Result := -1;
...
function TSnez.xxx_Group_Del_v2(ObjID, id_Group: Integer): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.xxx_SetGrp(ObjID, AID: Integer;
  id_Group: OleVariant): Integer;
begin
  Result := -1;
...
function TSnez.Acc_Del(ID_Acc: Integer): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
    ...
    try
      ...
      begin
        ...
        Close;
        LogMessage(ProcedureName + ' ' + E.Message);
        raise Exception.Create('Ошибка при удалении счета - ' + E.Message);
      end;
    end;
  end;
end;

function TSnez.Acc_Edit(id_Acc, AccName, Bank, id_business, PrsnAccName,
  CorrAccName, Inn, BIK, Disabled: OleVariant; NeedSend: WordBool;
...
function TSnez.MN_Del(id_MN: Integer): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.MN_Edit(id_Manufact, ManufactName, id_business, Addr,
  Disabled: OleVariant; NeedSend: WordBool; id_Group: OleVariant;
  ShowInRoot: WordBool): Integer;
begin
  Result := -1;
...
function TSnez.WH_Del(id_WH: Integer): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.WH_Edit(id_Warehouse, AName, id_business, Addr,
  Disabled: OleVariant; NeedSend: WordBool; id_Group: OleVariant;
  ShowInRoot: WordBool): Integer;
begin
  Result := -1;
...
function TSnez.UNSel_ReprBsn(Param1: Integer; var isOwn: WordBool;
...
function TSnez.ReprAdd_LC(isJur: WordBool; AName, FirstName, MiddleName,
  LastName, Id_Currency: OleVariant; Disabled: WordBool; Addr, Descr,
...
function TSnez.ReprEdit_LC(id_Repr: Integer; isJur: WordBool; AName,
  FirstName, MiddleName, LastName, Id_Currency: OleVariant;
...
function TSnez.GetAccName(id_Acc: Integer): OleVariant;
begin
  Result := '';
  with ADOStoredProc1 do
  begin
...
function TSnez.GetAccGroupName(id_Acc_Group: Integer): OleVariant;
begin
  Result := '';
  with ADOStoredProc1 do
  begin
...
function TSnez.GetWHGroupName(id_WHGroup: Integer): OleVariant;
begin
  Result := '';
  with ADOStoredProc1 do
  begin
...
function TSnez.GetWHName(id_WH: Integer): OleVariant;
begin
  Result := '';
  with ADOStoredProc1 do
  begin
...
function TSnez.GetCAName(ID_CA: Integer): OleVariant;
begin
  Result := '';
  with ADOStoredProc1 do
  begin
...
function TSnez.GetCAGroupName(id_CAGroup: Integer): OleVariant;
begin
  Result := '';
  with ADOStoredProc1 do
  begin
...
function TSnez.DD_MaxDay(id_business: Integer): OleVariant;
begin
  Result := Null;
  with ADOStoredProc1 do
  begin
...
function TSnez.OP_OperAdd_v2(OperVid: Integer; id_business: OleVariant;
...
begin
  if not IsBsnAv(id_business, -1) then
    raise Exception.Create('Нельзя добавлять операции в закрытый бизнес!!!');
...
function TSnez.OP_OperEdit_v2(id_Oper, OperVid: Integer;
...
function TSnez.OP_OperSetOperState_v2(id_Oper, OperState: Integer): Integer;
begin
  if not IsBsnAv(-1, id_Oper) then
    raise Exception.Create('ЭТОТ БИЗНЕС ЗАКРЫТ!!!');
  Result := -1;
...
function TSnez.OP_OperDelCheckDate_v2(id_Oper: Integer): Integer;
begin
  if not IsBsnAv(-1, id_Oper) then
    raise Exception.Create('ЭТОТ БИЗНЕС ЗАКРЫТ!!!');
  Result := -1;
...
function TSnez.OP_OperSetCheckDate_v2(id_Oper: Integer;
  id_UserChecker: OleVariant): Integer;
begin
  if not IsBsnAv(-1, id_Oper) then
    raise Exception.Create('ЭТОТ БИЗНЕС ЗАКРЫТ!!!');
...
function TSnez.PL_WareMeasureGet(id_Goods: OleVariant;
...
function TSnez.GetBsnCur(id_Bsn: Integer): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.UN_ShowInRoot(id_Acc, id_acc_Group, id_Warehouse,
  id_Warehouse_Group, id_ContrAgent, id_CAGroup, id_Manufact,
  id_Manufact_Group: OleVariant; ShowInRoot: WordBool): Integer;
begin
  Result := -1;
...
function TSnez.GetWateCtg(id_goods: OleVariant): OleVariant;
begin
  Result := Null;
  with ADOStoredProc1 do
  begin
...
function TSnez.DCh_Oper(id_business, OperVid: Integer; id_UserCreator,
...
function TSnez.DCh_OperWare(id_Oper: Integer; CtgName, GoodsName, MeasureName: OleVariant; AmountOper: Double;
...
function TSnez.OP_BuffAddItem(id_Buff, id_Oper: Integer): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.OP_OperWareAdd_BackToCA(id_Oper: Integer; id_Goods,
...
function TSnez.PL_WareNameGet(id_Goods : OleVariant; var AName, ShortName: OleVariant): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.LC_OP_OperAdd_v2(OperVid: Integer; id_business: OleVariant;
  Correct, OperTypeIn: WordBool; Id_CurrencyOper, PriceFinOper,
  Id_CurrencySys, SummSysFin, id_Acc, id_Acc_Ext, id_Warehouse,
  ...
  begin
    try
      ...
      begin
        ...
        Close;
        LogMessage(ProcedureName + ' ' + E.Message);
        raise Exception.Create('Произошла ощибка при сохранении операции' + #13 + #10 + E.Message);
      end;
    end;
  end;
end;

function TSnez.LC_OP_OperEdit_v2(id_LC_Oper, OperVid: Integer;
  id_business: OleVariant; Correct, OperTypeIn: WordBool; Id_CurrencyOper,
...
function TSnez.DCh_Oper_LC(id_business, OperVid: Integer;
  id_UserCreator: OleVariant; Correct, OperTypeIn: WordBool;
  CurrencyOperName, PriceFinOper, CurrencySysName, SummSysFin, AccName,
  AccName_Ext, WarehouseName, WarehouseName_Ext, ManufactName,
  ManufactName_Ext, ReprName, Imp_PayBasic, AccInv_PayAssignment,
...
function TSnez.DCh_OperWare_LC(id_LC_Oper: Integer; CtgName, GoodsName,
...
function TSnez.ExpSetID(id_Oper, id_LC_Oper: Integer): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
    ...
    try
      ...
      begin
        ...
        Close;
        LogMessage(ProcedureName + ' ' + E.Message);
        raise Exception.Create('Ошибка при загрузке отчета - ' + E.Message);
      end;
    end;
  end;
end;

procedure TSnez.RemoteDataModuleDestroy(Sender: TObject);
begin
  SvcForm.RemoveRDM(Self);
end;

function TSnez.OP_EmptyAdd(id_UserCreator: Integer; OperTypeIn: WordBool;
  id_DocType, Contract, OpComment: OleVariant; id_business: Integer;
  Imp_PayBasic, AccInv_PayAssignment: OleVariant): Integer;
begin
  Result := -1;
...
function TSnez.OP_EmptyEdit(id_Oper, id_UserCreator: Integer; id_DocType,
  Contract, OpComment: OleVariant; id_business: Integer; Imp_PayBasic,
...
function TSnez.SetUserDetail_2(Act, ID, FirstName, MiddleName, LastName,
...
procedure TSnez.SetUserGroups(Id, Ids: OleVariant);
begin
  with ADOStoredProc1 do
  begin
    try
...
function TSnez.SetGroupDetail(Act, Id, GroupName,
...
function TSnez.SetMeasureDetail(Act, ID, MeasureName, ShortName,
...
procedure TSnez.SetMeasureBusiness(Id, Ids: OleVariant);
begin
  with ADOStoredProc1 do
  begin
    try
...
function TSnez.SetBusinessDetail(Act, Id, BusinessName, ShortName,
...
function TSnez.SetReplicatorDetail(Act, Id, ReplicatorName, ShortName,
...
procedure TSnez.SetReplBusiness(Id, Ids: OleVariant);
begin
  with ADOStoredProc1 do
  begin
    try
...
function TSnez.SnglObj_Acc(id_User: Integer; out ObjName, ObjID, BsnName,
...
function TSnez.SnglObj_CA(id_User: Integer; out ObjName, ObjID, BsnName,
  id_business: OleVariant): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
...
function TSnez.SnglObj_MN(id_User: Integer; out ObjName, ObjID, BsnName,
  id_business: OleVariant): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
...
function TSnez.SnglObj_wh(id_User: Integer; out ObjName, ObjID, BsnName,
  id_business: OleVariant): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
...
function TSnez.MSG_Add(Body: OleVariant; id_User: Integer;
...
function TSnez.MSG_Edit(id_Msg: Integer; Body: OleVariant; id_User: Integer;
  WasRead: WordBool; DateClose, RepBody, id_State: OleVariant): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
...
function TSnez.MSG_SetClosed(id_Msg: Integer;
...
function TSnez.MSG_SetWasRead(id_Msg: Integer; WasRead: WordBool): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.OP_OperExtDataEdit_v2(id_Oper, AType, NumPrm: Integer;
...
function TSnez.Crn_URLAdd(AName, URL: OleVariant; UseTable, ColName, ColISO,
...
function TSnez.Crn_URLEdit(ID: Integer; AName, URL: OleVariant; UseTable,
  ColName, ColISO, ColCode, ColRate, ColPieces: Integer): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
...
function TSnez.CurrencyAdd_2(AName, ShortName, ISOCode,
  NumberCode: OleVariant; FastAccess: WordBool; AValue: Integer;
  Rate: OleVariant; AvForPay: WordBool; Id_URL: OleVariant;
...
function TSnez.CurrencyEdit_2(Id_Currency: Integer; AName, ShortName,
...
function TSnez.CurrencyEditRate(Id_Currency: Integer; Rate: Double): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.SetCurid_Bsn(Id_Currency, id_Bsn: Integer): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.AP_ObjEdit(id_AP_Obj, id_business: Integer; OperVid,
...
function TSnez.AP_CondClear(id_AP_Obj: Integer): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.AP_CondAdd(id_AP_Obj, ExtID, APCond: Integer; V_Str,
...
function TSnez.AP_ObjDel(id_AP_Obj: Integer): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.Doc_Pay_InEdit(id_Pay_In, id_Oper: Integer; Doc_Num,
...
function TSnez.Doc_ActClEdit(id_ActCl, id_Oper: Integer; Doc_Num, Doc_Date,
...
function TSnez.Doc_AccountEdit(id_Account, id_Oper: Integer; Doc_Num,
...
function TSnez.Doc_FinalActEdit(id_FinalAct, id_Oper: Integer; Doc_Num,
...
function TSnez.Doc_WarrantEdit(id_Warrant: Integer; GarbDate, Pspdate,
...
function TSnez.Doc_InvoiceEdit(id_invoice: Integer; V: OleVariant;
  id_Doc_Org: Integer): Integer;
var RecV_Inv : V_Inv;
begin
...
function TSnez.Doc_AFEdit(id_AF: Integer; V: OleVariant;
  id_Doc_Org: Integer): Integer;
var RR : V_AF;
begin
  RR := UnPackRecV_AF( V);
...
function TSnez.Doc_WBillEdit(id_WBill: Integer; V: OleVariant;
  id_Doc_Org: Integer): Integer;
var RR : V_WBill;
begin
...
function TSnez.DocDictEdit(ID: Integer; AName: OleVariant; id_DT: Integer;
  id_business: OleVariant): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
...
function TSnez.DocDictDel(id_DD: Integer): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.DocDictSetDef(id_DD: Integer): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.Doc_DictUNSetDef(id_DD: Integer): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.Doc_MeasureOKEI(ID_Measure: Integer): OleVariant;
begin
  Result := Null;
  with ADOStoredProc1 do
  begin
...
function TSnez.DocDel(AType, ID_Doc: Integer): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
procedure TSnez.Doc_ReprGetProp(id_Repr: Integer; out BIK, Bank, AccName,
...
procedure TSnez.Doc_GoodsGetProp(id_Goods: Integer; out GTD, Country,
...
function TSnez.GetDoc_Num(DocType: Integer): OleVariant;
begin
  Result := Null;
...
function TSnez.GetMNName(ID_MN: Integer): OleVariant;
begin
  Result := '';
  with ADOStoredProc1 do
  begin
...
function TSnez.GetReprName(id_Repr: Integer): OleVariant;
begin
  Result := '';
  with ADOStoredProc1 do
  begin
...
function TSnez.GetDoc_Num2(DocType, id_Bsn: Integer): OleVariant;
begin
  Result := Null;
  with spGetDoc_Num do
  begin
...
function TSnez.GetDefOrg(id_business: Integer; var id_Doc_Org, OrgName, INN,
...
function TSnez.Doc_OrgEdit(id_Doc_Org: Integer; Address, Buh,
...
function TSnez.Doc_OrgDel(id_Doc_Org: Integer): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.Doc_OrgBankGetDef(id_Doc_Org: Integer; var Bank, BIK, Acc,
...
function TSnez.DCh_MeasureAdd(id_business: Integer;
  AName: OleVariant): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
...
function TSnez.GetMeasureName(id_Measure: Integer): OleVariant;
begin
  Result := Null;
  with ADOStoredProc1 do
  begin
...
function TSnez.AP_ObjItemEdit(id_ObjItem, id_AP_Obj: Integer; OperVid,
...
function TSnez.AP_OperAdd(ExtID, id_ObjItem, ParamType: Integer; V_Str,
...
function TSnez.AP_OperClear(id_ObjItem: Integer): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.AP_ObjItemDel(id_ObjItem: Integer): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.AP_ObjItemSummAdd(id_ObjItemSumm, id_ObjItem: Integer;
...
function TSnez.UN_AccSumm(id_Acc: Integer; ADate: OleVariant): OleVariant;
begin
  Result := '';
  with spAccSumm do
  begin
...
function TSnez.UN_AccSummByCur(id_Acc: Integer; ADate: OleVariant;
...
function TSnez.Arc_OperAdd(id_business: Integer; ADate: TDateTime;
...
function TSnez.Arc_OperLastBal(id_business, DateCreate: Integer): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.UN_BalanceForm_v2(id_business: Integer): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.Arc_OperClear(id_business: Integer): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.Arc_OldOperCount(id_business: Integer; var id_OP_Arc,
  CNT: Integer): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
...
function TSnez.Bsn_DellAll(id_business: Integer): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.Arc_OP_OperAdd(V, Imp_PayBasic, AccInv_PayAssignment,
...
function TSnez.Arc_OP_OperWareAdd(V: OleVariant): Integer;
...
procedure TSnez.APOperSort(id_ObjItem, OrderNum: Integer);
begin
  with ADOStoredProc1 do
  begin
    try
...
function TSnez.SHOWCONTIG(TableName: OleVariant): OleVariant;
begin
  with ADOQuery1 do
  begin
    Close;
...
function TSnez.DBREINDEX(TableName: OleVariant): Integer;
begin
  Result := -1;
  with ADOQuery1 do
  begin
...
procedure TSnez.SetBaseName(AName, AUserName, APassword: OleVariant);
begin
  FBaseName := AName;
  FUserName := AUserName;
  FPassword := APassword;
...
function TSnez.GetCASumm(id_Currency, id_ContrAgent: Integer): OleVariant;
begin
  Result := 0;
  with spCASumm do
  begin
...
function TSnez.GetFirstRepr(id_ContrAgent: Integer): Integer;
begin
  Result := -1;
...
function TSnez.Crn_URLDel(Id_URL: Integer): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.BJ_TreeDel(id_BJ_Tree: Integer): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
    ...
    try
      ...
      begin
        ...
        Close;
        LogMessage(ProcedureName + ' ' + E.Message);
        raise Exception.Create('Ошибка при удалении группы - ' + E.Message);
      end;
    end;
  end;
end;

function TSnez.BJ_TreeEdit(id_BJ_Tree, id_BJ_Obj: Integer; AName,
  PID: OleVariant; isDeb: WordBool; ExtID: OleVariant): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
    ...
    try
      ...
      begin
        ...
        Close;
        LogMessage(ProcedureName + ' ' + E.Message);
        raise Exception.Create('Ошибка при создании - ' + E.Message);
      end;
    end;
  end;
end;

procedure TSnez.BJ_TreeGetProp(id_BJ_Tree: Integer; var id_BJ_Obj, AName,
  PID: OleVariant);
begin
  with ADOStoredProc1 do
  begin
...
function TSnez.BJ_TreeCheck(id_BJ_Tree: Integer; PID,
...
function TSnez.BJ_ItemEdit(id_BJ_Item, id_BJ_Tree: Integer; AName,
...
function TSnez.BJ_ObjEdit(id_BJ_Obj, id_business: Integer; AName, StartDate,
...
function TSnez.BJ_ItemDel(id_BJ_Item: Integer): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
procedure TSnez.Get_AccInfos(id_Acc: Integer; var AName,
...
function TSnez.BJ_ObjDel(id_BJ_Obj: Integer): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.BJ_ObjEdit2(id_BJ_Obj, id_business: Integer;
...
function TSnez.BJ_ObjDateStart(id_BJ_Obj: Integer): OleVariant;
begin
  Result := Null;
  with ADOStoredProc1 do
  begin
...
function TSnez.BJ_ItemSetOrdNum(id_BJ_Item, OrdNum: Integer): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.BJ_TreeSetOrdNum(id_BJ_Tree, OrdNum: Integer): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.BJ_Copy(OLD_ID, NEW_ID: Integer): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
    ...
    try
      ...
      begin
        ...
        Close;
        LogMessage(ProcedureName + ' ' + E.Message);
        raise Exception.Create('Ошибка при копировании - ' + E.Message);
      end;
    end;
  end;
end;

function TSnez.DD_MaxDay_Ex(id_business: Integer): OleVariant;
begin
  Result := Null;
  with ADOStoredProc1 do
  begin
...
function TSnez.BJ_Ch(id_BJ_Obj: Integer; aid_User: OleVariant): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.BJ_ItemEdit_Check(id_BJ_Item: Integer; isDirect,
...
function TSnez.Doc_WHOrdEdit(id_WHOrd: Integer; id_Doc_Org, id_Oper,
...
function TSnez.UN_InvCalc(OPComment, OrdN, id_Manufact,
...
function TSnez.GetINV_Form(id_business, ExtID: Integer): OleVariant;
begin
  Result := Null;
  with ADOStoredProc1 do
  begin
...
function TSnez.INV_GetFormPrice(id_Goods, id_manufact: Integer;
...
function TSnez.Inv_InvWare(OPComment, OrdN, GName,
...
function TSnez.Inv_InvGoods(OPComment, OrdN, Id_Ctg_Goods, Id_Ctg_Goods2,
  id_Manufact: OleVariant): OleVariant;
begin
  Result := Null;
  with ADOStoredProc1 do
...
function TSnez.Inv_TimeGet(id_Project, id_Lines: Integer;
...
function TSnez.INV_FormEdit(id_Form: Integer; Price: OleVariant): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
procedure TSnez.Inv_ProjectDel(id_Project: Integer);
begin
 // Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.Inv_ProjectEdit(id_Project: Integer; AName: OleVariant;
  id_User: Integer; PrjNum, PrjDate, id_Goods: OleVariant): OleVariant;
begin
  Result := -1;
  with ADOStoredProc1 do
...
function TSnez.Getid_Project: OleVariant;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
procedure TSnez.INV_LinesPrice(OrdNum, id_business: Integer; var id_Lines,
...
procedure TSnez.Inv_ProjectSetCheckDate(id_Project: Integer;
...
function TSnez.INV_ExtPrice(id_Lines: Integer;
...
function TSnez.Inv_GetMN(id_Manufact: Integer): OleVariant;
begin
  Result := Null;
  with ADOStoredProc1 do
  begin
...
function TSnez.Inv_ProjectComment(id_Project: Integer;
...
function TSnez.AP_CnstItemEdit(id_CnstItem: Integer; AName,
...
function TSnez.AP_CnstItemDel(id_CnstItem: Integer): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
procedure TSnez.AP_CnstGetProp(id_CnstItem: Integer; var ANAme,
  Val: OleVariant);
begin
  ANAme := Null;
  Val := Null;
...
function TSnez.CustRep_RepGetProp(id_Rep: Integer): OleVariant;
begin
  Result := Null;
  with ADOStoredProc1 do
  begin
...
procedure TSnez.CustRep_CatDel(id_Cat: Integer);
begin
  with ADOStoredProc1 do
  begin
    Close;
...
function TSnez.CustRep_CatAdd(id_Rep: Integer; AName, PID, ExtStr,
...
function TSnez.Inv_ProjectSetCheckDateFact(id_Project: Integer;
...
function TSnez.APN_ObjEdit(id_APN_Obj, id_business: Integer; id_Repr,
  id_Acc: OleVariant; OperTypeIn: WordBool; DayNum: Integer;
  AName: OleVariant): Integer;
begin
  Result := -1;
...
function TSnez.APN_AccListDel(id_APN_AccList: Integer): Integer;
begin
  with ADOStoredProc1 do
  begin
    Close;
...
function TSnez.APN_ObjDel(id_APN_Obj: Integer): Integer;
begin
  with ADOStoredProc1 do
  begin
    Close;
...
function TSnez.APN_ObjDoIt(id_APN_Obj: Integer): Integer;
begin
  with ADOStoredProc1 do
  begin
    Close;
...
function TSnez.APN_AccListEdit(id_APN_AccList, id_APN_Obj, id_Acc: Integer;
...
function TSnez.isPPP: WordBool;
begin
  Result := FisPPP;
end;

function TSnez.OP_ReplaceDate_CH(id_Oper: Integer;
...
function TSnez.PL_LastPrice(id_Goods: Integer): OleVariant;
begin
  Result := 0;
  with spLastPrice do
  begin
...
function TSnez.DD_Cancel(id_business: Integer): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.DCh_Oper_Impex(DateCreate: OleVariant; id_business, OperVid,
  OperTypeIn: Integer; CurrencyOperName, PriceFinOper: OleVariant;
  id_Acc: Integer; AccInv_PayAssignment, OpComment, KS, ReprName, INN,
...
function TSnez.OP__SetKoeff(Koeff, id_Oper: Integer): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.OffPayment(id_CA: Integer): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.DCh_WareGoodsAdd(id_business: Integer; CtgName,
  AName: OleVariant; id_Measure: Integer): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
    try
      Close;
      ProcedureName := 'DCh_WareGoodsAdd';
      Parameters.Refresh;
      Parameters.ParamByName('@id_business').Value := id_business;
      Parameters.ParamByName('@CtgName').Value := CtgName;
      Parameters.ParamByName('@Name').Value := AName;
...
function TSnez.DCh_WareHouseAdd(id_business: Integer;
  AName: OleVariant): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
    try
      Close;
      ProcedureName := 'DCh_WareHouseAdd';
      Parameters.Refresh;
      Parameters.ParamByName('@id_business').Value := id_business;
      Parameters.ParamByName('@Name').Value := AName;
...
function TSnez.DCh_WareAmountAdd(id_business, id_Goods, id_Warehouse,
  id_Measure: Integer; Amount, Price: OleVariant): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
    try
      Close;
      ProcedureName := 'DCh_WareAmountAdd';
      Parameters.Refresh;
      Parameters.ParamByName('@id_business').Value := id_business;
      Parameters.ParamByName('@id_Goods').Value := id_Goods;
      Parameters.ParamByName('@id_Warehouse').Value := id_Warehouse;
...
function TSnez.DCh_ReprAdd(id_business: Integer; AName,
  CAName: OleVariant): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
...
function TSnez.DCh_CA_DeptAdd(id_business, id_Repr: Integer; S_RUB, S_USD,
  S_EUR: OleVariant): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
    try
      Close;
      ProcedureName := 'DCh_CA_DeptAdd';
      Parameters.Refresh;
      Parameters.ParamByName('@id_business').Value := id_business;
      Parameters.ParamByName('@id_Repr').Value := id_Repr;
      Parameters.ParamByName('@S_RUB').Value := S_RUB;
      Parameters.ParamByName('@S_USD').Value := S_USD;
      Parameters.ParamByName('@S_EUR').Value := S_EUR;
      Parameters.ParamByName('@id_UserCreator').Value := Fid_User;
...
function TSnez.DCh_WareAmount_IMP(id_Goods_OLD,
  id_Goods_NEW: Integer): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
    try
      Close;
      ProcedureName := 'DCh_WareAmount_IMP';
      Parameters.Refresh;
      Parameters.ParamByName('@id_Goods_OLD').Value := id_Goods_OLD;
      Parameters.ParamByName('@id_Goods_NEW').Value := id_Goods_NEW;
      Parameters.ParamByName('@id_UserCreator').Value := Fid_User;
...
function TSnez.PL_Ctg_Goods_COPY(id_business_OLD, id_business_new: Integer;
  NeedAmount: WordBool): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
    try
      Close;
      ProcedureName := 'PL_Ctg_Goods_COPY';
      Parameters.Refresh;
      Parameters.ParamByName('@id_business_OLD').Value := id_business_OLD;
      Parameters.ParamByName('@id_business_new').Value := id_business_new;
      Parameters.ParamByName('@NeedAmount').Value := NeedAmount;
...
function TSnez.Bsn_BlockBusiness(id_business: Integer;
  Block: WordBool): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
    try
      Close;
      ProcedureName := 'Bsn_BlockBusiness';
      Parameters.Refresh;
      Parameters.ParamByName('@id_business').Value := id_business;
      Parameters.ParamByName('@Block').Value := Block;
...
function TSnez.IsBsnAv(id_business, id_Oper: integer): boolean;
var Q : TADOQuery;
begin
  Result := true;
 { if id_business > 0 then
  ...
  begin
    Close;
  if id_business > 0 then
    Parameters[0].Value := id_business
  else
    Parameters[0].Value := id_Oper;

    Open;
    Result := qBsnid_Main.AsInteger > 0;
    Close;
  end; }
end;

function TSnez.BJ_ObjEdit_v2(id_BJ_Obj, id_business: Integer; AName,
  StartDate, StopDate: OleVariant): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
    ...
    try
      ...
      Parameters.ParamByName('@StopDate').Value := StopDate;
      Parameters.ParamByName('@id_Creator').Value := Fid_User;
      SetTParametersVal(Parameters, '@Ver', 2);
...
function TSnez.BJ_ItemEdit_v2(id_BJ_Item, id_BJ_Tree, AName, PlanIn,
  id_ContrAgent, id_Acc, NeedCalc, isDirect, isInState, PlanDelta1,
  PlanCorrect1, PlanDelta2, PlanCorrect2, PlanDelta3, PlanCorrect3,
  PlanDelta4, PlanCorrect4, PlanDelta5, PlanCorrect5, PlanDelta6,
  PlanCorrect6, PlanDelta7, PlanCorrect7, PlanDelta8, PlanCorrect8,
  ...
  PlanCorrect11, PlanDelta12, PlanCorrect12: OleVariant): Integer;
begin
  if id_BJ_Item = -1 then id_BJ_Item := null;
  Result := -1;
  with ADOStoredProc1 do
  begin
    Close;
    ProcedureName := 'BJ_ItemEdit_v2';
    try
      Close;
      Parameters.Refresh;
      SetTParametersVal(Parameters, '@id_BJ_Item', id_BJ_Item);
      SetTParametersVal(Parameters, '@id_BJ_Tree', id_BJ_Tree);
      SetTParametersVal(Parameters, '@Name', AName);
      SetTParametersVal(Parameters, '@PlanIn', PlanIn);
      SetTParametersVal(Parameters, '@id_ContrAgent', id_ContrAgent);
      SetTParametersVal(Parameters, '@id_Acc', id_Acc);
      SetTParametersVal(Parameters, '@NeedCalc', NeedCalc);
      SetTParametersVal(Parameters, '@isDirect', isDirect);
      SetTParametersVal(Parameters, '@isInState', isInState);
      SetTParametersVal(Parameters, '@PlanDelta1', PlanDelta1);
      SetTParametersVal(Parameters, '@PlanCorrect1', PlanCorrect1);
      SetTParametersVal(Parameters, '@PlanDelta2', PlanDelta2);
      SetTParametersVal(Parameters, '@PlanCorrect2', PlanCorrect2);
      SetTParametersVal(Parameters, '@PlanDelta3', PlanDelta3);
      SetTParametersVal(Parameters, '@PlanCorrect3', PlanCorrect3);
      SetTParametersVal(Parameters, '@PlanDelta4', PlanDelta4);
      SetTParametersVal(Parameters, '@PlanCorrect4', PlanCorrect4);
      SetTParametersVal(Parameters, '@PlanDelta5', PlanDelta5);
      SetTParametersVal(Parameters, '@PlanCorrect5', PlanCorrect5);
      SetTParametersVal(Parameters, '@PlanDelta6', PlanDelta6);
      SetTParametersVal(Parameters, '@PlanCorrect6', PlanCorrect6);
      SetTParametersVal(Parameters, '@PlanDelta7', PlanDelta7);
      SetTParametersVal(Parameters, '@PlanCorrect7', PlanCorrect7);
      SetTParametersVal(Parameters, '@PlanDelta8', PlanDelta8);
      SetTParametersVal(Parameters, '@PlanCorrect8', PlanCorrect8);
      SetTParametersVal(Parameters, '@PlanDelta9', PlanDelta9);
      SetTParametersVal(Parameters, '@PlanCorrect9', PlanCorrect9);
      SetTParametersVal(Parameters, '@PlanDelta10', PlanDelta10);
      SetTParametersVal(Parameters, '@PlanCorrect10', PlanCorrect10);
      SetTParametersVal(Parameters, '@PlanDelta11', PlanDelta11);
      SetTParametersVal(Parameters, '@PlanCorrect11', PlanCorrect11);
      SetTParametersVal(Parameters, '@PlanDelta12', PlanDelta12);
      SetTParametersVal(Parameters, '@PlanCorrect12', PlanCorrect12);
...
procedure TSnez.BJ_Copy2(OLD_ID, NEW_ID: Integer);
begin
end;

function TSnez.AddGoods(Atype, GoodsCatName, GoodsName, Price, Ball,
  Descr: OleVariant): Integer;
begin

end;

function TSnez.BJ_SetInitial(id_BJ_Obj, Month,
  SetNull: OleVariant): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
    try
      Close;
      ProcedureName := 'BJ_SetInitial';

      Parameters.Refresh;
      Parameters.ParamByName('@id_BJ_Obj').Value := id_BJ_Obj;
      Parameters.ParamByName('@Month').Value := Month;
      Parameters.ParamByName('@id_User').Value := Fid_User;
      Parameters.ParamByName('@SetNull').Value := SetNull;
...
procedure TSnez.BJ_OperRelEDIT(id_BJ_Obj, id_BJ_Item, id_Oper: Integer);
begin
  with spOperBJ do
  begin
    try
      Close;
      Parameters.ParamByName('@id_OperRel').Value := -1;
      Parameters.ParamByName('@id_BJ_Obj').Value := id_BJ_Obj;
      Parameters.ParamByName('@NotUse').Value := not (id_BJ_Item > 0);
      if id_BJ_Item > 0 then
        Parameters.ParamByName('@id_BJ_Item').Value := id_BJ_Item
      else
        Parameters.ParamByName('@id_BJ_Item').Value := Null;
      Parameters.ParamByName('@id_Oper').Value := id_Oper;
...
function TSnez.WareUnEdit(id_Goods: Integer; id_Ctg_Goods, AName,
  ShortName, BarCode: OleVariant; Disabled: WordBool; id_Measure, GTD,
  Country, DocNomCode, DocPriceCode, DocArt, DocNumber,
  Price: OleVariant): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
    Close;
    ProcedureName := 'PL_GoodsUNEdit';
    try
      Close;
      Parameters.Refresh;
      SetTParametersVal(Parameters, '@id_Goods', id_Goods);
      SetTParametersVal(Parameters, '@id_Ctg_Goods', id_Ctg_Goods);
      SetTParametersVal(Parameters, '@Name', AName);
      SetTParametersVal(Parameters, '@ShortName', ShortName);
      SetTParametersVal(Parameters, '@BarCode', BarCode);
      SetTParametersVal(Parameters, '@Disabled', Disabled);
      SetTParametersVal(Parameters, '@id_Measure', id_Measure);
      SetTParametersVal(Parameters, '@GTD', GTD);
      SetTParametersVal(Parameters, '@Country', Country);
      SetTParametersVal(Parameters, '@DocNomCode', DocNomCode);
      SetTParametersVal(Parameters, '@DocPriceCode', DocPriceCode);
      SetTParametersVal(Parameters, '@DocArt', DocArt);
      SetTParametersVal(Parameters, '@DocNumber', DocNumber);
      SetTParametersVal(Parameters, '@Price', Price);
...
function TSnez.SetProcedureName(AProcedureName : String): Integer;
begin
  with ADOStoredProc1 do
  begin
      Close;
...
function TSnez.Imp_Oper_UnEdit(id_Bsn, OperDate, Summ, Narr, ReprName,
  OperType, OperNum, OperNum2, Acc: OleVariant): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
    SetProcedureName('Imp_Oper_UnEdit');
 
    SetTParametersVal(Parameters, '@id_Bsn', id_Bsn);
    SetTParametersVal(Parameters, '@OperDate', OperDate);
    SetTParametersVal(Parameters, '@Summ', Summ);
    SetTParametersVal(Parameters, '@Narr', Narr);
    SetTParametersVal(Parameters, '@ReprName', ReprName);
    SetTParametersVal(Parameters, '@OperType', OperType);
    SetTParametersVal(Parameters, '@OperNum', OperNum);
    SetTParametersVal(Parameters, '@OperNum2', OperNum2);
    SetTParametersVal(Parameters, '@Acc', Acc);
    Result := ExecSP;
  end;
end;

function TSnez.Inv_DictAdd(xType: Integer; Val: OleVariant): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
  begin
    try
      Close;
      ProcedureName := 'Inv_DictAdd';

      Parameters.Refresh;

      Parameters.ParamByName('@xType').Value := xType;
...
function TSnez.OP_BlockIt(id_business: Integer;
  VirtDate: OleVariant): Integer;
begin
  Result := -1;
  with ADOStoredProc1 do
...
procedure TSnez.UnBeforeOpen(DataSet: TDataSet);
var AParam : TParameter;
begin
...
initialization
  TComponentFactory.Create(ComServer, TSnez,
    Class_Snez, ciMultiInstance, tmApartment);
end.
