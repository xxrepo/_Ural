object Snez: TSnez
  ...
  object spPrjList: TADOStoredProc
    ...
    object spPrjListid_BSN: TIntegerField
      FieldName = 'id_BSN'
    end
    object spPrjListOLD_PPP: TIntegerField
      FieldName = 'OLD_PPP'
    end
    object spPrjListLineNum: TIntegerField
      FieldName = 'LineNum'
    end
  end
  object spPP: TADOStoredProc
    ...
    object spPPid_BSN: TIntegerField
      FieldName = 'id_BSN'
    end
    object spPPOLD_PPP: TIntegerField
      FieldName = 'OLD_PPP'
    end
    object spPPLineNum: TIntegerField
      FieldName = 'LineNum'
    end
  end
  object dsPP: TSQLUpdateDSProvider
    ...
    ModifySQL.Strings = (
      ...
      ' ')
    InsertSQL.Strings = (
      'Exec Inv_ProjectAdd @Comment = :Comment,  @id_Bsn = :id_Bsn,'
      '  @Klishe_Price2 = :Klishe_Price2,'
      '  @Klishe_Amount2 = :Klishe_Amount2,'
      ''
      '  @Name = :Name,'
  ...
  object qBsn: TADOQuery
    ...
    SQL.Strings = (
        ...
        'select id_Main FROM Dic_business (NOLOCK) WHERE id_business = :i' +
        'd_business')
    Left = 1056
    Top = 8
    object qBsnid_Main: TIntegerField
      FieldName = 'id_Main'
    end
  end
  object qOp: TADOQuery
    ...
    SQL.Strings = (
      'select B.id_Main'
      'FROM Dic_business B (NOLOCK)'
      'JOIN OP_Oper2 OP (NOLOCK) ON OP.id_business = B.id_business'
  ...
  object spRepSvod: TADOStoredProc
    Connection = ADOConnection1
    CursorType = ctStatic
    ProcedureName = 'RPT_NewRepSVOD;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
  ...
  object dsRepSvod: TDataSetProvider
    DataSet = spRepSvod
    Constraints = True
    Left = 1064
    Top = 304
  end
  object dsRPT_OLD_CA: TDataSetProvider
    DataSet = spRPT_OLD_CA
    Constraints = True
    Left = 1080
    Top = 408
  end
  object spRPT_OLD_CA: TADOStoredProc
    Connection = ADOConnection1
    CursorType = ctStatic
    ProcedureName = 'RPT_OLD_CA;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
  ...
  object dsRPT_OLD_WARE: TDataSetProvider
    DataSet = spRPT_OLD_WARE
    Constraints = True
    Left = 1080
    Top = 528
  end
  object spRPT_OLD_WARE: TADOStoredProc
    Connection = ADOConnection1
    CursorType = ctStatic
    ProcedureName = 'RPT_OLD_WARE;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
  ...
  object spBJList2: TADOStoredProc
    Connection = ADOConnection1
    CursorType = ctStatic
    ProcedureName = 'BJ_ObjList_v2;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
  ...
  object dsBJList2: TDataSetProvider
    DataSet = spBJList2
    Constraints = True
    Left = 1160
    Top = 152
  end
  object spBJTree2: TADOStoredProc
    Connection = ADOConnection1
    CursorType = ctStatic
    ProcedureName = 'BJ_TreeGetList_v2;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
  ...
  object dsBJTree2: TDataSetProvider
    DataSet = spBJTree2
    Constraints = True
    Left = 1168
    Top = 248
  end
  object spBIP2: TADOStoredProc
    Connection = ADOConnection1
    CursorType = ctStatic
    ProcedureName = 'BJ_ItemGetProp_v2;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
    ...
    Left = 1162
    Top = 308
    object spBIP2isDeb: TBooleanField
      FieldName = 'isDeb'
    end
    object spBIP2P_Name: TStringField
      FieldName = 'P_Name'
      Size = 255
    end
    object spBIP2id_BJ_Obj: TIntegerField
      FieldName = 'id_BJ_Obj'
    end
    object spBIP2id_business: TIntegerField
      FieldName = 'id_business'
    end
    object spBIP2ExtID: TIntegerField
      FieldName = 'ExtID'
    end
    object spBIP2RealName: TStringField
      FieldName = 'RealName'
      Size = 255
    end
    object spBIP2id_BJ_Item: TAutoIncField
      FieldName = 'id_BJ_Item'
    end
    object spBIP2id_BJ_Tree: TIntegerField
      FieldName = 'id_BJ_Tree'
    end
    object spBIP2Name: TStringField
      FieldName = 'Name'
      Size = 255
    end
    object spBIP2Disabled: TBooleanField
      FieldName = 'Disabled'
    end
    object spBIP2PlanIn: TBCDField
      FieldName = 'PlanIn'
      Precision = 19
    end
    object spBIP2PlanDelta: TBCDField
      FieldName = 'PlanDelta'
      Precision = 19
    end
    object spBIP2id_Acc: TIntegerField
      FieldName = 'id_Acc'
    end
    object spBIP2id_ContrAgent: TIntegerField
      FieldName = 'id_ContrAgent'
    end
    object spBIP2OrdNum_I: TIntegerField
      FieldName = 'OrdNum_I'
    end
    object spBIP2old_I: TIntegerField
      FieldName = 'old_I'
    end
    object spBIP2PlanCorrect: TBCDField
      FieldName = 'PlanCorrect'
      Precision = 19
    end
    object spBIP2isDirect: TBooleanField
      FieldName = 'isDirect'
    end
    object spBIP2isInState: TBooleanField
      FieldName = 'isInState'
    end
    object spBIP2PlanDelta1: TFloatField
      FieldName = 'PlanDelta1'
    end
    object spBIP2PlanCorrect1: TFloatField
      FieldName = 'PlanCorrect1'
    end
    object spBIP2PlanDelta2: TFloatField
      FieldName = 'PlanDelta2'
    end
    object spBIP2PlanCorrect2: TFloatField
      FieldName = 'PlanCorrect2'
    end
    object spBIP2PlanDelta3: TFloatField
      FieldName = 'PlanDelta3'
    end
    object spBIP2PlanCorrect3: TFloatField
      FieldName = 'PlanCorrect3'
    end
    object spBIP2PlanDelta4: TFloatField
      FieldName = 'PlanDelta4'
    end
    object spBIP2PlanCorrect4: TFloatField
      FieldName = 'PlanCorrect4'
    end
    object spBIP2PlanDelta5: TFloatField
      FieldName = 'PlanDelta5'
    end
    object spBIP2PlanCorrect5: TFloatField
      FieldName = 'PlanCorrect5'
    end
    object spBIP2PlanDelta6: TFloatField
      FieldName = 'PlanDelta6'
    end
    object spBIP2PlanCorrect6: TFloatField
      FieldName = 'PlanCorrect6'
    end
    object spBIP2PlanDelta7: TFloatField
      FieldName = 'PlanDelta7'
    end
    object spBIP2PlanCorrect7: TFloatField
      FieldName = 'PlanCorrect7'
    end
    object spBIP2PlanDelta8: TFloatField
      FieldName = 'PlanDelta8'
    end
    object spBIP2PlanCorrect8: TFloatField
      FieldName = 'PlanCorrect8'
    end
    object spBIP2PlanDelta9: TFloatField
      FieldName = 'PlanDelta9'
    end
    object spBIP2PlanCorrect9: TFloatField
      FieldName = 'PlanCorrect9'
    end
    object spBIP2PlanDelta10: TFloatField
      FieldName = 'PlanDelta10'
    end
    object spBIP2PlanCorrect10: TFloatField
      FieldName = 'PlanCorrect10'
    end
    object spBIP2PlanDelta11: TFloatField
      FieldName = 'PlanDelta11'
    end
    object spBIP2PlanCorrect11: TFloatField
      FieldName = 'PlanCorrect11'
    end
    object spBIP2PlanDelta12: TFloatField
      FieldName = 'PlanDelta12'
    end
    object spBIP2PlanCorrect12: TFloatField
      FieldName = 'PlanCorrect12'
    end
  end
  object dsBIP2: TDataSetProvider
    DataSet = spBIP2
    Constraints = True
    Left = 1162
    Top = 354
  end
  object spBJDet2: TADOStoredProc
    Connection = ADOConnection1
    CursorType = ctStatic
    ProcedureName = 'BJ_TreeGet_Det_v2;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
  ...
  object dsBJDet2: TDataSetProvider
    DataSet = spBJDet2
    Constraints = True
    Left = 1144
    Top = 48
  end
  object spOperBJ: TADOStoredProc
    Connection = ADOConnection1
    CursorType = ctStatic
    ProcedureName = 'BJ_OperRelEDIT;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
  ...
  object spObr: TADOStoredProc
    Connection = ADOConnection1
    CursorType = ctStatic
    ProcedureName = 'Rep_2014_TestPrint;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
  ...
  object dsOrb: TDataSetProvider
    DataSet = spObr
    Constraints = True
    Left = 1080
    Top = 632
  end
  object spInvDict: TADOStoredProc
    Connection = ADOConnection1
    CursorType = ctStatic
    ProcedureName = 'Inv_DictGetList;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
  ...
  object dsInvDict: TDataSetProvider
    DataSet = spInvDict
    Constraints = True
    Left = 1144
    Top = 616
  end
  object dsInvC: TDataSetProvider
    DataSet = spInvC
    Constraints = True
    Left = 1176
    Top = 528
  end
  object spInvC: TADOStoredProc
    Connection = ADOConnection1
    CursorType = ctStatic
    ProcedureName = 'Inv_DictCalc;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
  ...
  object spPrevFact: TADOStoredProc
    Connection = ADOConnection1
    CursorType = ctStatic
    ProcedureName = 'Inv_Rep_v2;1'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
  ...
  object dsPrevFact: TDataSetProvider
    DataSet = spPrevFact
    Constraints = True
    Left = 1152
    Top = 456
