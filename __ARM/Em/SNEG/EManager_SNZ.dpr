...
uses
  ...
  uWHImport in '..\..\units\Catalog\uWHImport.pas' {WHImport},
  uCAImport in '..\..\units\Catalog\uCAImport.pas' {CAImport},
  uRepLoss in '..\..\units\Rpt_v2\uRepLoss.pas' {RepLoss},
  uRepLossDet in '..\..\units\Rpt_v2\uRepLossDet.pas' {RepLossDet},
  uRepOld in '..\..\units\Rpt_v2\uRepOld.pas' {RepOld},
  uRepSvod in '..\..\units\Rpt_v2\uRepSvod.pas' {RepSvod},
  ...
  uRepObr in '..\..\units\Rpt_v2\uRepObr.pas' {RepObr},
  uRepPrevF in '..\..\units\Rpt_v2\uRepPrevF.pas' {RepPrevF},
  uOperBlockIT in '..\..\units\Oper_v2\uOperBlockIT.pas' {OperBlockIT},
  uOperFinSmp in '..\..\units\Oper_v2\uOperFinSmp.pas' {OperFinSmp},
  frOperFinSmp in '..\..\units\Oper_v2\frOperFinSmp.pas' {fOperFinSmp: TFrame},
  uClImport in '..\..\units\Catalog\uClImport.pas' {ClImport},
  uSelDocNum in '..\..\units\Doc\uSelDocNum.pas' {SelDocNum},
  EhLibCDS in '..\..\..\..\..\Program Files (x86)\Borland\Delphi5\MyVCL\EhLib\Delphi5\EhLibCDS.pas',
  DbUtilsEh in '..\..\..\..\..\Program Files (x86)\Borland\Delphi5\MyVCL\EhLib\Delphi5\DBUtilsEh.pas';

{$R *.RES}

begin
  Application.Initialize;
  Application.Title := 'Снежинск. 1:1 Управленческий учет';
