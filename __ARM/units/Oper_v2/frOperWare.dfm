object fOperWare: TfOperWare
  ...
  object cdsOperWare: TClientDataSet
    ...
    object cdsOperWareSS_SYS: TAggregateField
      FieldName = 'SS_SYS'
      Active = True
      Expression = 'Sum(SummSys)'
    end
  end
  ...
  object ActionList1: TActionList
    ...
    object aCalcSys: TAction
      Caption = 'Рассчитать сумму зачета'
      Enabled = False
    ...
    object aCalcOper: TAction
      Caption = 'Рассчитать сумму операции'
      Enabled = False
      Hint = 'Рассчитать сумму операции'
      ImageIndex = 32
  ...
  object cdsOperWare201: TClientDataSet
    ...
    object cdsOperWare201AmountOper: TFloatField
      FieldName = 'AmountOper'
      DisplayFormat = '000 000 000000.00'
      EditFormat = '0'
    end
    ...
    object cdsOperWare201SS_SYS: TAggregateField
      FieldName = 'SS_SYS'
      Active = True
      DisplayFormat = '### ### ### ##0.00'
      Expression = 'Sum(SummSys)'
