object APOperList: TAPOperList
  Left = 217
  Top = 166
  Width = 1099
  Height = 423
  Caption = 'Генерация операций'
  Color = clBtnFace
  ...
  object RxDBGrid1: TDBGridEh
    ...
    OnMouseDown = RxDBGrid1MouseDown
    OnSelectionChanged = RxDBGrid1SelectionChange
    ...
    Columns = <
      item
        ...
        Footers = <>
        ReadOnly = True
        Title.Caption = 'Порядок создания'
        Width = 57
        WordWrap = True
      end
      item
  ...
  object ilImage: TImageList
    ...
    Bitmap = {
      ...
      E007E00700000000F81FF81F00000000FC1FE1A3FFF7FFFFF007E1A3FFE7FFC8
  ...
  object dsDoFilter: TDataSource
    DataSet = cdsDoFilter
    OnDataChange = dsDoFilterDataChange
    Left = 296
    Top = 208
  end
  object cdsDoFilter: TClientDataSet
    Aggregates = <>
    Params = <
      item
        DataType = ftInteger
    ...
    ProviderName = 'dsDoFilter'
    RemoteServer = DM.rsCA
    Left = 296
    Top = 165
    object cdsDoFilterid_ObjItem: TIntegerField
      FieldName = 'id_ObjItem'
    end
    object cdsDoFilterExtId: TIntegerField
      FieldName = 'ExtId'
    end
    object cdsDoFilterOperVid: TIntegerField
      FieldName = 'OperVid'
    end
    object cdsDoFilterid_UserCreator: TIntegerField
      FieldName = 'id_UserCreator'
    end
    object cdsDoFilterid_UserChecker: TIntegerField
      FieldName = 'id_UserChecker'
    end
    object cdsDoFilterid_business: TIntegerField
      FieldName = 'id_business'
    end
    object cdsDoFilterCorrect: TBooleanField
      FieldName = 'Correct'
    end
    object cdsDoFilterOperTypeIn: TBooleanField
      FieldName = 'OperTypeIn'
    end
    object cdsDoFilterid_Acc: TIntegerField
      FieldName = 'id_Acc'
    end
    object cdsDoFilterid_Warehouse: TIntegerField
      FieldName = 'id_Warehouse'
    end
    object cdsDoFilterid_Manufact: TIntegerField
      FieldName = 'id_Manufact'
    end
    object cdsDoFilterid_Repr: TIntegerField
      FieldName = 'id_Repr'
    end
    object cdsDoFilterid_Acc_Ext: TIntegerField
      FieldName = 'id_Acc_Ext'
    end
    object cdsDoFilterid_Warehouse_Ext: TIntegerField
      FieldName = 'id_Warehouse_Ext'
    end
    object cdsDoFilterid_Manufact_Ext: TIntegerField
      FieldName = 'id_Manufact_Ext'
    end
    object cdsDoFilterKoeff: TIntegerField
      FieldName = 'Koeff'
    end
    object cdsDoFilterid_FormalDistrib: TIntegerField
      FieldName = 'id_FormalDistrib'
    end
    object cdsDoFilterid_FuncDistrib: TIntegerField
      FieldName = 'id_FuncDistrib'
    end
    object cdsDoFilterImp_PayBasic: TStringField
      FieldName = 'Imp_PayBasic'
      Size = 1000
    end
    object cdsDoFilterAccInv_PayAssignment: TStringField
      FieldName = 'AccInv_PayAssignment'
      Size = 1000
    end
    object cdsDoFilterContract: TStringField
      FieldName = 'Contract'
      Size = 1000
    end
    object cdsDoFilterOpComment: TStringField
      FieldName = 'OpComment'
      Size = 1000
    end
    object cdsDoFilterDig1: TFloatField
      FieldName = 'Dig1'
    end
    object cdsDoFilterDig2: TFloatField
      FieldName = 'Dig2'
    end
    object cdsDoFilterDig3: TFloatField
      FieldName = 'Dig3'
    end
    object cdsDoFilterDig4: TFloatField
      FieldName = 'Dig4'
    end
    object cdsDoFilterDig5: TFloatField
      FieldName = 'Dig5'
    end
    object cdsDoFilterDig6: TFloatField
      FieldName = 'Dig6'
    end
    object cdsDoFilterDig7: TFloatField
      FieldName = 'Dig7'
    end
    object cdsDoFilterDig8: TFloatField
      FieldName = 'Dig8'
    end
    object cdsDoFilterDig9: TFloatField
      FieldName = 'Dig9'
    end
    object cdsDoFilterDig10: TFloatField
      FieldName = 'Dig10'
    end
    object cdsDoFilterDig11: TFloatField
      FieldName = 'Dig11'
    end
    object cdsDoFilterDig12: TFloatField
      FieldName = 'Dig12'
    end
    object cdsDoFilterDig13: TFloatField
      FieldName = 'Dig13'
    end
    object cdsDoFilterDig14: TFloatField
      FieldName = 'Dig14'
    end
    object cdsDoFilterDig15: TFloatField
      FieldName = 'Dig15'
    end
    object cdsDoFilterStr1: TStringField
      FieldName = 'Str1'
      Size = 100
    end
    object cdsDoFilterStr2: TStringField
      FieldName = 'Str2'
      Size = 100
    end
    object cdsDoFilterStr3: TStringField
      FieldName = 'Str3'
      Size = 100
    end
    object cdsDoFilterStr4: TStringField
      FieldName = 'Str4'
      Size = 100
    end
    object cdsDoFilterStr5: TStringField
      FieldName = 'Str5'
      Size = 100
    end
    object cdsDoFilterStr6: TStringField
      FieldName = 'Str6'
      Size = 100
    end
    object cdsDoFilterStr7: TStringField
      FieldName = 'Str7'
      Size = 100
    end
    object cdsDoFilterStr8: TStringField
      FieldName = 'Str8'
      Size = 100
    end
    object cdsDoFilterStr9: TStringField
      FieldName = 'Str9'
      Size = 100
    end
    object cdsDoFilterStr10: TStringField
      FieldName = 'Str10'
      Size = 100
    end
    object cdsDoFilterStr11: TStringField
      FieldName = 'Str11'
      Size = 100
    end
    object cdsDoFilterStr12: TStringField
      FieldName = 'Str12'
      Size = 100
    end
    object cdsDoFilterStr13: TStringField
      FieldName = 'Str13'
      Size = 100
    end
    object cdsDoFilterStr14: TStringField
      FieldName = 'Str14'
      Size = 100
    end
    object cdsDoFilterStr15: TStringField
      FieldName = 'Str15'
      Size = 100
    end
    object cdsDoFilterId_CurrencyOper: TIntegerField
      FieldName = 'Id_CurrencyOper'
    end
    object cdsDoFilterId_CurrencySys: TIntegerField
      FieldName = 'Id_CurrencySys'
    end
    object cdsDoFilterOperVidName: TStringField
      FieldName = 'OperVidName'
      ReadOnly = True
      Size = 50
    end
    object cdsDoFilterContrAgentName: TStringField
      FieldName = 'ContrAgentName'
      ReadOnly = True
      Size = 50
    end
    object cdsDoFilterFormalDistribName: TStringField
      FieldName = 'FormalDistribName'
      Size = 50
    end
    object cdsDoFilterFuncDistribName: TStringField
      FieldName = 'FuncDistribName'
      Size = 50
    end
    object cdsDoFilterKoeffName: TStringField
      FieldName = 'KoeffName'
      ReadOnly = True
      Size = 50
    end
    object cdsDoFilterSrcName: TStringField
      FieldName = 'SrcName'
      ReadOnly = True
      Size = 50
    end
    object cdsDoFilterReprName: TStringField
      FieldName = 'ReprName'
      ReadOnly = True
      Size = 255
    end
    object cdsDoFilterTypeName: TStringField
      FieldName = 'TypeName'
      ReadOnly = True
      Size = 30
    end
    object cdsDoFilterBusinessid_Currency: TIntegerField
      FieldName = 'Businessid_Currency'
    end
    object cdsDoFilterBusinessName: TStringField
      FieldName = 'BusinessName'
      Size = 50
    end
    object cdsDoFilterBusinessNum: TStringField
      FieldName = 'BusinessNum'
      Size = 5
    end
    object cdsDoFilterOperCrnName: TStringField
      FieldName = 'OperCrnName'
      ReadOnly = True
      Size = 10
    end
    object cdsDoFilterCurrencyBsnName: TStringField
      FieldName = 'CurrencyBsnName'
      ReadOnly = True
      Size = 10
    end
    object cdsDoFilterCurrencySysShortName: TStringField
      FieldName = 'CurrencySysShortName'
      Size = 10
    end
    object cdsDoFilterCurrencyOperShortName: TStringField
      FieldName = 'CurrencyOperShortName'
      Size = 10
    end
    object cdsDoFilterid_AP_Obj: TIntegerField
      FieldName = 'id_AP_Obj'
    end
    object cdsDoFilterWareName: TStringField
      FieldName = 'WareName'
      ReadOnly = True
      Size = 255
    end
    object cdsDoFilterMeasureName: TStringField
      FieldName = 'MeasureName'
      ReadOnly = True
      Size = 255
    end
    object cdsDoFilterParName: TStringField
      FieldName = 'ParName'
      Size = 255
    end
    object cdsDoFilterAPName: TStringField
      FieldName = 'APName'
      Size = 50
    end
    object cdsDoFilterParField: TStringField
      FieldName = 'ParField'
      Size = 255
    end
    object cdsDoFilterOpName: TStringField
      FieldName = 'OpName'
      Size = 255
    end
    object cdsDoFilterid_Goods: TIntegerField
      FieldName = 'id_Goods'
    end
    object cdsDoFilterid_Measure: TIntegerField
      FieldName = 'id_Measure'
    end
    object cdsDoFilterVatIn: TBooleanField
      FieldName = 'VatIn'
    end
    object cdsDoFilterPriceOper: TFloatField
      FieldName = 'PriceOper'
    end
    object cdsDoFilterSummOper: TFloatField
      FieldName = 'SummOper'
    end
    object cdsDoFilterSummSys: TFloatField
      FieldName = 'SummSys'
    end
    object cdsDoFilterPriceOper_F: TFloatField
      FieldName = 'PriceOper_F'
      DisplayFormat = '### ### ##0.##'
    end
    object cdsDoFilterSummOper_F: TFloatField
      FieldName = 'SummOper_F'
      DisplayFormat = '### ### ##0.##'
      EditFormat = '0.##'
    end
    object cdsDoFilterSummSys_F: TFloatField
      FieldName = 'SummSys_F'
      DisplayFormat = '### ### ##0.##'
      EditFormat = '0.##'
    end
    object cdsDoFilterForOrd: TIntegerField
      FieldKind = fkInternalCalc
      FieldName = 'ForOrd'
    end
    object cdsDoFilterChOnRate: TBooleanField
      FieldName = 'ChOnRate'
    end
    object cdsDoFilterAmountOper: TBCDField
      FieldName = 'AmountOper'
      Precision = 30
      Size = 2
    end
