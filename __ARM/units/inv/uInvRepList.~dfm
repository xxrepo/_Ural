object InvRepList: TInvRepList
  ...
  Width = 926
  Height = 540
  Caption = 'Сравнительная таблица по себестоимости'
  Color = clBtnFace
  ...
  object RxDBGrid1: TDBGridEh
    ...
    Columns = <
      ...
      item
        ...
        Footers = <>
        Title.Caption = 'Количество|Предварительное'
        Title.EndEllipsis = True
        Title.TitleButton = True
        Width = 99
      end
      item
        ...
        Footer.ValueType = fvtSum
        Footers = <>
        Title.Caption = 'Количество|Фактическое'
        Title.EndEllipsis = True
        Title.TitleButton = True
        Width = 101
      end
      item
        ...
        Footer.ValueType = fvtSum
        Footers = <>
        Title.Caption = 'Себестоимость|Предварительная'
        Title.EndEllipsis = True
        Title.TitleButton = True
        Width = 98
      end
      item
        ...
        Footer.ValueType = fvtSum
        Footers = <>
        Title.Caption = 'Себестоимость|Фактическая'
        Title.EndEllipsis = True
        Title.TitleButton = True
        Width = 97
      end
      item
        ...
        Footer.ValueType = fvtSum
        Footers = <>
        Title.Caption = 'Себестоимость|Разница'
        Title.TitleButton = True
        Width = 86
      end
      item
        ...
        Footer.ValueType = fvtSum
        Footers = <>
        Title.Caption = 'Себестоимость|Разница на валу'
        Title.TitleButton = True
        Width = 103
      end
      item
      ...
      item
        ...
        Footer.ValueType = fvtSum
        Footers = <>
        Title.Caption = 'КЛИШЕ|Предвар. себест'
        Title.EndEllipsis = True
        Title.TitleButton = True
        Width = 88
      end
      item
        ...
        Footer.ValueType = fvtSum
        Footers = <>
        Title.Caption = 'КЛИШЕ|Фактическая себестоимость'
        Title.EndEllipsis = True
        Title.TitleButton = True
        Width = 93
      end
      ...
      item
        ...
        Footer.ValueType = fvtSum
        Footers = <>
        Title.Caption = 'КЛИШЕ|Отпускная цена'
        Title.EndEllipsis = True
        Title.Font.Charset = DEFAULT_CHARSET
        Title.Font.Color = clWindowText
        Title.Font.Height = -11
      ...
      item
        ...
        Footer.ValueType = fvtSum
        Footers = <>
        Title.Caption = 'СЫРЬЕ|Формный|Предварительное сырье'
        Title.EndEllipsis = True
        Title.TitleButton = True
        Width = 94
      end
      item
        ...
        Footer.ValueType = fvtSum
        Footers = <>
        Title.Caption = 'СЫРЬЕ|Формный|Фактическое сырье'
        Title.TitleButton = True
        Width = 82
      end
      item
        ...
        Footer.ValueType = fvtSum
        Footers = <>
        Title.Caption = 'СЫРЬЕ|Формный|Разница'
        Title.Font.Charset = DEFAULT_CHARSET
        Title.Font.Color = clWindowText
        Title.Font.Height = -11
        Title.Font.Name = 'MS Sans Serif'
      ...
      item
        ...
        Footer.ValueType = fvtSum
        Footers = <>
        Title.Caption = 'СЫРЬЕ|Печати|Предварительное сырье'
        Title.EndEllipsis = True
        Title.TitleButton = True
        Width = 79
      end
      item
        ...
        Footer.ValueType = fvtSum
        Footers = <>
        Title.Caption = 'СЫРЬЕ|Печати|Фактическое сырье'
        Title.EndEllipsis = True
        Title.TitleButton = True
        Width = 88
      end
      item
        ...
        Footer.ValueType = fvtSum
        Footers = <>
        Title.Caption = 'СЫРЬЕ|Печати|Разница'
        Title.EndEllipsis = True
        Title.Font.Charset = DEFAULT_CHARSET
        Title.Font.Color = clWindowText
        Title.Font.Height = -11
      ...
      item
        ...
        Footer.ValueType = fvtSum
        Footers = <>
        Title.Caption = 'СЫРЬЕ|Ламинирования|Предварительное сырье'
        Title.EndEllipsis = True
        Title.TitleButton = True
        Width = 79
      end
      item
        ...
        Footer.ValueType = fvtSum
        Footers = <>
        Title.Caption = 'СЫРЬЕ|Ламинирования|Фактическое сырье'
        Title.EndEllipsis = True
        Title.TitleButton = True
        Width = 88
      end
      item
        ...
        Footer.ValueType = fvtSum
        Footers = <>
        Title.Caption = 'СЫРЬЕ|Ламинирования|Разница'
        Title.EndEllipsis = True
        Title.Font.Charset = DEFAULT_CHARSET
        Title.Font.Color = clWindowText
        Title.Font.Height = -11
      ...
      item
        ...
        Footer.ValueType = fvtSum
        Footers = <>
        Title.Caption = 'СЫРЬЕ|Резка|Предварительное сырье'
        Title.EndEllipsis = True
        Title.TitleButton = True
        Width = 114
      end
      item
        ...
        Footer.ValueType = fvtSum
        Footers = <>
        Title.Caption = 'СЫРЬЕ|Резка|Фактическое сырье'
        Title.EndEllipsis = True
        Title.TitleButton = True
        Width = 88
      end
      item
        ...
        Footer.ValueType = fvtSum
        Footers = <>
        Title.Caption = 'СЫРЬЕ|Резка|Разница'
        Title.EndEllipsis = True
        Title.Font.Charset = DEFAULT_CHARSET
        Title.Font.Color = clWindowText
        Title.Font.Height = -11
