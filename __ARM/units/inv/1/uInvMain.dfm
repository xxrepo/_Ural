object InvMain: TInvMain
  ...
  object cdsTime: TClientDataSet
    ...
    ProviderName = 'dsTime'
    RemoteServer = DM.rsCA
    OnCalcFields = cdsTimeCalcFields
    Left = 448
    Top = 176
    object cdsTimeid_TimeItem: TAutoIncField
      FieldName = 'id_TimeItem'
      ReadOnly = True
    end
    object cdsTimeVal: TDateTimeField
      FieldName = 'Val'
      OnGetText = cdsTimeValPlanGetText
      DisplayFormat = 'dd hh:nn'
      EditMask = '!90:00;1; '
    end
    object cdsTimeid_TimeDict: TIntegerField
      FieldName = 'id_TimeDict'
    end
    object cdsTimeid_Project: TIntegerField
      FieldName = 'id_Project'
    end
    object cdsTimeName: TStringField
      FieldName = 'Name'
      Size = 255
    end
    object cdsTimeLName: TStringField
      FieldName = 'LName'
      Size = 255
    end
    object cdsTimeValPlan: TDateTimeField
      FieldName = 'ValPlan'
      OnGetText = cdsTimeValPlanGetText
      DisplayFormat = 'dd hh:nn'
      EditMask = '!99 90:00;1; '
    end
    object cdsTimeVal2: TFloatField
      FieldKind = fkInternalCalc
      FieldName = 'Val2'
      DisplayFormat = '0.00'
      EditFormat = '0.##'
    end
    object cdsTimerrr: TDateTimeField
      FieldKind = fkInternalCalc
      FieldName = 'rrr'
      OnGetText = cdsTimerrrGetText
      DisplayFormat = 'hh:nn'
    end
    object cdsTimeValPlan2: TFloatField
      FieldKind = fkInternalCalc
      FieldName = 'ValPlan2'
      DisplayFormat = '0.00'
      EditFormat = '0.##'
    end
    object cdsTimeTimePricePlan: TFloatField
      FieldName = 'TimePricePlan'
      ReadOnly = True
      DisplayFormat = '0.00'
    end
    object cdsTimeSummPlan: TFloatField
      FieldKind = fkInternalCalc
      FieldName = 'SummPlan'
      DisplayFormat = '0.00'
    end
    object cdsTimeVal2_2: TFloatField
      FieldKind = fkInternalCalc
      FieldName = 'Val2_2'
      DisplayFormat = '0.00'
      EditFormat = '0.##'
    end
    object cdsTimeValPlan2_2: TFloatField
      FieldKind = fkInternalCalc
      FieldName = 'ValPlan2_2'
      DisplayFormat = '0.00'
      EditFormat = '0.##'
    end
    object cdsTimeid_Lines: TIntegerField
      FieldName = 'id_Lines'
    end
    object cdsTimerrrPPP: TFloatField
      FieldKind = fkInternalCalc
      FieldName = 'rrrPPP'
      DisplayFormat = '0.00'
    end
    object cdsTimeExtID: TIntegerField
      FieldName = 'ExtID'
    end
    object cdsTimeSummF: TFloatField
      FieldKind = fkInternalCalc
      FieldName = 'SummF'
      DisplayFormat = '0.00'
    end
  ...
  object cdsInvWare: TClientDataSet
    Aggregates = <
      item
        Active = True
        AggregateName = 'S_K_AmountPlan'
        Expression = 'sum(K_AmountPlan)'
        Visible = False
      end
      item
        Active = True
        AggregateName = 'S_K_Amount'
        Expression = 'sum(K_Amount)'
        Visible = False
      end
      item
        Active = True
        AggregateName = 'S_PPPPricePlan'
        Expression = 'sum(PPPPricePlan)'
        Visible = False
      end
      item
        Active = True
        AggregateName = 'S_PPPPrice'
