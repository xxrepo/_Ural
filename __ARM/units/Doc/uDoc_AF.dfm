object AF: TAF
  ...
  object GroupBox1: TGroupBox
    ...
    object edRC_Address2: TDBEdit
      Left = 355
      Top = 98
      Width = 262
      Height = 21
      DataField = 'RC_Address2'
      DataSource = DataSource1
      TabOrder = 8
    end
    object edExtDocNum: TDBEdit
      Left = 107
      Top = 129
      Width = 200
      Height = 21
    ...
    object edExtDocDate: TDBDateEdit
      Left = 355
      Top = 129
      Width = 121
      Height = 21
      DataField = 'ExtDocDate'
      DataSource = DataSource1
      NumGlyphs = 2
      TabOrder = 10
    end
    object edBayer_INN: TDBEdit
      Left = 356
      Top = 154
      Width = 78
      Height = 21
    ...
    object edBayer_Address: TDBEdit
      Left = 107
      Top = 178
      Width = 510
      Height = 21
      DataField = 'Bayer_Address'
      DataSource = DataSource1
      TabOrder = 16
    end
    ...
    object edSender_Address2: TDBEdit
      Left = 355
      Top = 65
      Width = 238
      Height = 21
      DataField = 'Sender_Address2'
      DataSource = DataSource1
      TabOrder = 6
    end
    ...
    object DBGridEh1: TDBGridEh
      ...
      Columns = <
        ...
        item
          ...
          FieldName = 'MesName'
          Footers = <>
          Title.Caption = 'Единица измерения|Полное название'
          Width = 120
        end
        item
          EditButtons = <>
          FieldName = 'MesName_Code'
          Footers = <>
          ReadOnly = True
          Title.Caption = 'Единица измерения|Код'
          Width = 50
        end
        item
          AlwaysShowEditButton = True
          ...
          Footers = <>
          ReadOnly = True
          Title.Caption = 'Единица измерения|Условное обозначение'
          Width = 103
        end
        item
          AlwaysShowEditButton = True
        ...
        item
          ...
          FieldName = 'Country'
          Footers = <>
          Title.Caption = 'Страна|Полное название'
          Width = 100
        end
        item
          EditButtons = <>
          FieldName = 'Country_calc'
          Footers = <>
          Title.Caption = 'Страна|Название'
          Width = 120
        end
        item
          EditButtons = <>
  ...
  object cdsDoc: TClientDataSet
    ...
    ProviderName = 'dsDoc_AF'
    RemoteServer = DM.rsCA
    Left = 632
    Top = 189
    object cdsDocid_AF: TAutoIncField
      FieldName = 'id_AF'
    end
    ...
    object cdsDocINN: TBCDField
      FieldName = 'INN'
      OnGetText = cdsDocINNGetText
      Precision = 12
      Size = 0
    end
    object cdsDocKPP: TBCDField
      FieldName = 'KPP'
      OnGetText = cdsDocKPPGetText
      Precision = 10
      Size = 0
    end
    object cdsDocSender_Name: TStringField
      FieldName = 'Sender_Name'
      Size = 255
    end
    object cdsDocSender_Address2: TStringField
      FieldName = 'Sender_Address2'
      OnGetText = cdsDocSender_Address2GetText
      Size = 255
    end
    ...
    object cdsDocRC_Address2: TStringField
      FieldName = 'RC_Address2'
      OnGetText = cdsDocRC_Address2GetText
      Size = 255
    end
    object cdsDocExtDocNum: TStringField
      FieldName = 'ExtDocNum'
      Size = 255
    end
    object cdsDocExtDocDate: TDateTimeField
      FieldName = 'ExtDocDate'
    end
    object cdsDocBayer_Name: TStringField
      FieldName = 'Bayer_Name'
      Size = 255
    end
    object cdsDocBayer_Address: TStringField
      FieldName = 'Bayer_Address'
      OnGetText = cdsDocBayer_AddressGetText
      Size = 255
    end
    object cdsDocBayer_INN: TBCDField
      FieldName = 'Bayer_INN'
      OnGetText = cdsDocINNGetText
      Precision = 12
      Size = 0
    end
    object cdsDocBayer_KPP: TBCDField
      FieldName = 'Bayer_KPP'
      OnGetText = cdsDocKPPGetText
      Precision = 10
      Size = 0
    end
    object cdsDocPBUL: TStringField
      FieldName = 'PBUL'
      Size = 255
    end
  ...
  object PopupMenu1: TPopupMenu
    ...
    object miOpen: TMenuItem
      Caption = 'Открыть новый вариант счета-фактуры'
      OnClick = miOpenClick
    end
    object N1: TMenuItem
      Caption = 'Открыть старый вариант счета-фактуры'
      OnClick = N1Click
    end
  ...
  object cdsDocWare: TClientDataSet
    ...
    object cdsDocWareid_AFWare: TAutoIncField
      FieldName = 'id_AFWare'
      ReadOnly = True
    end
    ...
    object cdsDocWareid_AF: TIntegerField
      FieldName = 'id_AF'
    end
    ...
    object cdsDocWareCountry: TStringField
      FieldName = 'Country'
      Size = 255
    end
    object cdsDocWareGTD: TStringField
      FieldName = 'GTD'
      Size = 255
    end
    ...
    object cdsDocWareMesName_calc: TStringField
      FieldKind = fkInternalCalc
      FieldName = 'MesName_calc'
      Size = 255
    end
    object cdsDocWareMesName_Code: TStringField
      FieldKind = fkInternalCalc
      FieldName = 'MesName_Code'
      Size = 255
    end
    object cdsDocWareCountry_calc: TStringField
      FieldKind = fkInternalCalc
      FieldName = 'Country_calc'
      Size = 255
    end
    object cdsDocWareCountry_code: TStringField
      FieldKind = fkInternalCalc
      FieldName = 'Country_code'
      Size = 255
    end
    ...
    object cdsDocWareSSVATVal: TAggregateField
      FieldName = 'SSVATVal'
      Active = True
