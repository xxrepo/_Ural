object WBill: TWBill
    ...
    object DBGridEh1: TDBGridEh
      ...
      Columns = <
        ...
        item
          ...
          FieldName = 'PRCNum'
          Footers = <>
          Title.Caption = 'Номер прейскуранта'
          Width = 80
        end
        item
          EditButtons = <>
        ...
        item
          ...
          Footer.EndEllipsis = True
          Footers = <>
          Title.Caption = 'Номер по складской картотеке'
          Width = 122
        end
        item
          EditButtons = <>
  ...
  object cdsDoc: TClientDataSet
    ...
    ProviderName = 'dsDoc_WBill'
    RemoteServer = DM.rsCA
    Left = 632
    Top = 189
    object cdsDocid_WBill: TAutoIncField
      FieldName = 'id_WBill'
      ReadOnly = True
    end
    ...
    object cdsDocChecker_post: TStringField
      FieldName = 'Checker_post'
      Size = 255
    end
    object cdsDocChecker_Name: TStringField
  ...
  object cdsDocWare: TClientDataSet
    ...
    object cdsDocWareid_WBillWare: TAutoIncField
      FieldName = 'id_WBillWare'
      ReadOnly = True
    end
    object cdsDocWareid_WBill: TIntegerField
      FieldName = 'id_WBill'
    end
    ...
    object cdsDocWarePRCNum: TStringField
      FieldName = 'PRCNum'
      Size = 50
    end
    object cdsDocWareCardNum: TStringField
      FieldName = 'CardNum'
      Size = 50
    end
    object cdsDocWareArticul: TStringField
      FieldName = 'Articul'
      Size = 50
    end
    ...
    object cdsDocWareSSBrutto: TAggregateField
      FieldName = 'SSBrutto'
      Active = True
      Expression = 'sum(Brutto)'
    end
    object cdsDocWareSSPalaceCount: TAggregateField
      FieldName = 'SSPalaceCount'
      Active = True
      Expression = 'sum(PalaceCount)'
    end
  end
