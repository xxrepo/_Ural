...
type
  TOperList_Pribil = class(TRptForm)
  private
...
var
  OperList_Pribil: TOperList_Pribil;
...
procedure TOperList_Pribil.Refr;
...
constructor TOperList_Pribil.Create(AOwner: TCOmponent);
begin
  inherited;

end;

destructor TOperList_Pribil.Destroy;
begin
  inherited;
