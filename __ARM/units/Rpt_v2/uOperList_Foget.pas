...
type
  TOperList_Foget = class(TRptForm)
...
var
  OperList_Foget: TOperList_Foget;
...
procedure TOperList_Foget.Refr;
...
constructor TOperList_Foget.Create(AOwner: TCOmponent);
begin
  inherited;
...
destructor TOperList_Foget.Destroy;
begin
  inherited;
