...
var
  ...
  function MakeFS(ABaseName, AUserName, APassword : String) : TMemoryStream;
...
begin
  ...
  begin
    ...
    ConnectionString := 'Provider=SQLOLEDB.1;Password="' +
      ...
      String(FUserName) + ';Initial Catalog=master;Data Source=' + FBaseName +
  ...
  try
    ...
    FS := MakeFS(FBaseName, FUserName, FPassword );
